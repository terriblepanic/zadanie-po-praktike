...
namespace AutoRepairWorkshop
{
    public partial class UcRemont : UserControl
    {
        ...
        private Panel CreateCard(string title, string name, string line1, string line2, string line3, string line4, string status, string kodAvto, string kodNeispr, DateTime postDate)
        {
